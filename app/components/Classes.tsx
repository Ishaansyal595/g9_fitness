...
const Classes = () => {
  const classes = [
    {
      name: "Body Building",
      img: "/assets/body-building.jpg",
      description:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque adipisci nemo ipsa fuga facilis? Quas?",
    },
    {
      name: "Cardio",
      img: "/assets/cardio2.png",
      description:
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque adipisci nemo ipsa fuga facilis? Quas?",
    },
    {
      ...
      >
        {classes.map((item, index) => {
          return (
            <div
              key={index}
              className="w-full h-[300px] relative lg:h-[485px] flex flex-col justify-center items-center"
            >
              {/* Overlay */}
